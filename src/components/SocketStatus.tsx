...
export default function SocketStatus() {
  const { status: socketStatus, retries } = useSocket();
  ...
  else if (socketStatus === "failed") { color = "text-red-500"; text = "Fallo de conexión"; console.error('[SocketStatus] Fallo de conexión con el servidor de señalización.'); }
